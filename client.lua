...
RegisterNetEvent('mg-weapon-sling:client:setSlingPosition')
AddEventHandler('mg-weapon-sling:client:setSlingPosition', function(newSling)
    sling = newSling
    for model, attached_object in pairs(attached_weapons) do
        ...
        AttachEntityToEntity(attached_object.handle, PlayerPedId(), GetPedBoneIndex(PlayerPedId(), pos.bone), pos.x, pos.y, pos.z, pos.x_rotation, pos.y_rotation, pos.z_rotation, 1, 1, 0, 0, 2, 1)
    end
end)
